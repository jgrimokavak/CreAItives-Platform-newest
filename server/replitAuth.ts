...
// Email domain restriction - only allow @kavak.com emails
const ALLOWED_EMAIL_DOMAINS = ["@kavak.com"];
...
async function upsertUser(
  ...
  if (!isEmailAllowed(email)) {
    throw new Error(`Access restricted. Only users with ${ALLOWED_EMAIL_DOMAINS.join(' or ')} email addresses are allowed.`);
  }
